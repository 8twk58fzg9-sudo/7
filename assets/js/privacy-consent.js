(function () {
  ...
  function deleteAnalyticsCookies() {
    document.cookie.split(";").forEach(function (entry) {
      ...
      if (!/^_(ga|gid|gat|clck|clsk)/i.test(name)) return;
  ...
  function loadClarity() {
    ...
    script.addEventListener("load", function () { signalClarityConsent(hasAnalyticsConsent()); }, { once: true });
